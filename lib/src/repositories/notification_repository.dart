...
import 'package:taker_driver/src/models/user.dart';

import 'package:firebase_core/firebase_core.dart';
import '../../firebase_options.dart';
import 'package:firebase_messaging/firebase_messaging.dart';
import 'package:taker_driver/src/services/notification_service.dart'
...
class NotificationRepository {
  ...
  Future<void> updateFcmToken(User currentUser) async {
    if (currentUser.auth && FirebaseMessaging.instance.isSupported()) {
